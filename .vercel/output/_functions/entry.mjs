...
import { A as fetchStateSymbol, C as isRoute500, D as REDIRECT_STATUS_CODES, E as DEFAULT_404_COMPONENT, F as generateCspDigest, M as responseSentSymbol$1, N as decodeKey, O as REROUTABLE_STATUS_CODES, P as decryptString, S as isRoute404, T as ASTRO_GENERATOR, _ as isAstroComponentFactory, a as renderComponent, b as renderEndpoint, c as renderSlotToString, g as pushDirective, h as normalizeCspResourceEntry, i as renderJSX, j as originPathnameSymbol, k as clientAddressSymbol, l as isRenderTemplateResult, m as isRenderInstruction, o as chunkToString, r as renderPage, s as createSlotValueFromString, u as renderTemplate, v as markHTMLString, w as ASTRO_ERROR_HEADER } from "./chunks/server_2EROUCmy.mjs";
...
var middlewareSecret = "42dc6355-501f-454c-adfd-6d5ad1b11d78";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/track.ts",
			"pathname": "/api/track",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_CCerSiqC.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/track_CeU7MQaY.mjs");
var _page2 = () => import("./chunks/index_CP38xxCQ.mjs");
...
var _manifest = deserializeManifest({"rootDir":"file:///Users/jr-mb/Development/bee-tween-links/","cacheDir":"file:///Users/jr-mb/Development/bee-tween-links/node_modules/.astro/","outDir":"file:///Users/jr-mb/Development/bee-tween-links/dist/","srcDir":"file:///Users/jr-mb/Development/bee-tween-links/src/","publicDir":"file:///Users/jr-mb/Development/bee-tween-links/public/","buildClientDir":"file:///Users/jr-mb/Development/bee-tween-links/dist/client/","buildServerDir":"file:///Users/jr-mb/Development/bee-tween-links/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/track","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/track\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"track","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/track.ts","pathname":"/api/track","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/song/[id]","isIndex":false,"type":"page","pattern":"^\\/song\\/([^/]+?)\\/?$","segments":[[{"content":"song","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/song/[id].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":":root{--bg:#0c0a09;--panel:#120e0cdb;--text:#f8f3ed;--muted:#b8ada3;--border:#ffffff1a;--button:#f6f1eb;--button-text:#17120f;--button-hover:#fff;--shadow:0 20px 60px #00000073;--radius:22px}[data-astro-cid-dimny6ja]{box-sizing:border-box}html,body{background:var(--bg);min-height:100%;color:var(--text);margin:0;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Inter,Helvetica,Arial,sans-serif}body{place-items:center;min-height:100vh;padding:28px 18px;display:grid;overflow-x:hidden}body:before{filter:blur(34px)saturate(.95);transform:scale(1.08)}body:after{content:\"\";z-index:-1;pointer-events:none;background:radial-gradient(circle at 50% 20%,#ffaf5f14,#0000 45%);position:fixed;inset:0}.page[data-astro-cid-dimny6ja]{width:min(100%,430px)}.card[data-astro-cid-dimny6ja]{background:var(--panel);border:1px solid var(--border);border-radius:var(--radius);box-shadow:var(--shadow);-webkit-backdrop-filter:blur(18px);padding:18px}.cover-wrap[data-astro-cid-dimny6ja]{aspect-ratio:1;background:#19130f;border-radius:16px;overflow:hidden;box-shadow:0 14px 35px #0000006b}.cover[data-astro-cid-dimny6ja]{object-fit:cover;width:100%;height:100%;display:block}.meta[data-astro-cid-dimny6ja]{text-align:center;padding:20px 8px 14px}h1[data-astro-cid-dimny6ja]{letter-spacing:-.025em;margin:0;font-size:clamp(1.55rem,6vw,2rem);font-weight:720;line-height:1.08}.artist[data-astro-cid-dimny6ja]{color:var(--muted);letter-spacing:.08em;text-transform:uppercase;margin:8px 0 0;font-size:1rem;font-weight:650}.hint[data-astro-cid-dimny6ja]{color:#d8cfc7;margin:12px 0 0;font-size:.92rem;line-height:1.45}.links[data-astro-cid-dimny6ja]{gap:11px;margin-top:8px;display:grid}.service[data-astro-cid-dimny6ja]{background:var(--button);width:100%;color:var(--button-text);border-radius:14px;align-items:center;gap:12px;min-height:58px;padding:14px 16px;font-weight:700;text-decoration:none;transition:transform .15s,background .15s,box-shadow .15s;display:flex;box-shadow:0 8px 18px #0000002e}.service[data-astro-cid-dimny6ja]:hover{background:var(--button-hover);transform:translateY(-1px);box-shadow:0 11px 22px #0000003d}.service[data-astro-cid-dimny6ja]:active{transform:translateY(0)}.icon[data-astro-cid-dimny6ja]{color:#fff;background:#17120f;border-radius:10px;flex:0 0 34px;place-items:center;width:34px;height:34px;font-size:17px;font-weight:800;display:grid}.service-copy[data-astro-cid-dimny6ja]{flex-direction:column;min-width:0;line-height:1.1;display:flex}.service-copy[data-astro-cid-dimny6ja] small[data-astro-cid-dimny6ja]{color:#746b64;margin-bottom:3px;font-size:.72rem;font-weight:600}.service-copy[data-astro-cid-dimny6ja] strong[data-astro-cid-dimny6ja]{white-space:nowrap;font-size:1rem}.arrow[data-astro-cid-dimny6ja]{color:#746b64;margin-left:auto;font-size:1.25rem;line-height:1}.footer[data-astro-cid-dimny6ja]{text-align:center;color:#ffffff7a;margin-top:16px;font-size:.76rem}@media (width<=380px){body,.card[data-astro-cid-dimny6ja]{padding:14px}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/jr-mb/Development/bee-tween-links/src/pages/song/[id].astro",{"propagation":"none","containsHead":true}],["/Users/jr-mb/Development/bee-tween-links/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_CCerSiqC.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_CP38xxCQ.mjs","/Users/jr-mb/Development/bee-tween-links/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_D49gDvmK.mjs","\u0000virtual:astro:page:src/pages/api/track@_@ts":"chunks/track_CeU7MQaY.mjs","virtual:astro:noop":"_astro/_virtual_astro_noop.SBldSjMi.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/favicon.ico","/favicon.svg"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"GBZkj2RU4mXXQ+U1BaRWDoQ/h3Vpjd9Jp44jBlFc7AM=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/jr-mb/Development/bee-tween-links/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/jr-mb/Development/bee-tween-links/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "42dc6355-501f-454c-adfd-6d5ad1b11d78") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
